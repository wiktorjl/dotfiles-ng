...
# Colors for output. Only emit ANSI when stdout is a real terminal — otherwise
# piping/redirecting (`./review_logs.sh --latest > out.txt`, `| grep ...`)
# leaves literal escape sequences in the captured text.
if [ -t 1 ]; then
    RED='\033[0;31m'
    GREEN='\033[0;32m'
    YELLOW='\033[1;33m'
